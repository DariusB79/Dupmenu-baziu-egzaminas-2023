    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartamentLesson", x => new { x.DepartamentsId, x.LessonsId });
                    table.ForeignKey(
                        name: "FK_DepartamentLesson_Departaments_DepartamentsId",
                        column: x => x.DepartamentsId,
                        principalTable: "Departaments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DepartamentLesson_Lessons_LessonsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartamentLesson_LessonsId",
                table: "DepartamentLesson",
                column: "LessonsId");
